...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activerecord>.freeze, ["= 5.1.6.1"])
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 5.1.6.1"])
      s.add_runtime_dependency(%q<activejob>.freeze, ["= 5.1.6.1"])
      s.add_runtime_dependency(%q<actioncable>.freeze, ["= 5.1.6.1"])
      s.add_runtime_dependency(%q<railties>.freeze, ["= 5.1.6.1"])
      s.add_runtime_dependency(%q<bundler>.freeze, [">= 1.3.0"])
      s.add_runtime_dependency(%q<sprockets-rails>.freeze, [">= 2.0.0"])
    else
      s.add_dependency(%q<activesupport>.freeze, ["= 5.1.6.1"])
      ...
      s.add_dependency(%q<activerecord>.freeze, ["= 5.1.6.1"])
      s.add_dependency(%q<actionmailer>.freeze, ["= 5.1.6.1"])
      s.add_dependency(%q<activejob>.freeze, ["= 5.1.6.1"])
      s.add_dependency(%q<actioncable>.freeze, ["= 5.1.6.1"])
      s.add_dependency(%q<railties>.freeze, ["= 5.1.6.1"])
